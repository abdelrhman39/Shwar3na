    ...
    public function showForgetPasswordForm()
      {
        ...
        $about_data =  AboutUs::first();
         return view('auth.password.forgetPassword',['all_category'=>$all_category,'about_data'=>$about_data]);
      }
      ...
      public function showResetPasswordForm($token) {
        $all_category = Category::Select()->get();
        $about_data =  AboutUs::first();
         return view('auth.password.forgetPasswordLink', ['token' => $token,'all_category'=>$all_category,'about_data'=>$about_data]);
      }
      /**
       * Write code on Method
       *
