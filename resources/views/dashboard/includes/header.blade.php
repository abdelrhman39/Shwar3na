            ...
            <ul class="nav navbar-nav flex-row">
                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="{{route('dashboard.dashboard')}}">
                        <img class="brand-logo" alt="Shwar3na Logo" style="width: 26px"
                             src="{{asset('uploads/icon.jpg')}}">
                        <h3 class="brand-text">ِشوارعنا</h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    <li class="nav-item d-none d-md-block"><a class="nav-link nav-link-expand" ><i
                ...
                <span class="mr-1">مرجبا
                  ...
                  <img  style="height: 35px;" src="/uploads/users/{{auth()->User()->image}}" alt="avatar"><i></i></span>
                        </a>
