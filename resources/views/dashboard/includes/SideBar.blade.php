...
<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{  request()->routeIs('dashboard.dashboard') ? 'active' : '' }}"><a href="{{route('dashboard.dashboard')}}"><i class="la la-dashboard"></i><span
                class="menu-title" data-i18n="nav.add_on_drag_drop.main">الرئيسية </span></a>
            </li>

            <li class="nav-item {{  request()->routeIs('admin.users') ? 'active' : '' }}"><a href="{{route('admin.users')}}"><i class="la la-users"></i>
              <span class="menu-title" data-i18n="nav.changelog.main">المستخدمين </span>
              <span class="badge badge badge-pill badge-warning float-right" style=" left: 40px">{{App\Models\UserRole::where('type', 2)->count()}}</span>
              </a>
            </li>
            ...
            <li class="nav-item  ">
              ...
              <a href=""><i class="icon-grid"></i>
                ...
                <ul class="menu-content">
                    <li class="{{  request()->routeIs('admin.Categories') ? 'active' : '' }}"><a class="menu-item" href="{{route('admin.Categories')}}" data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li class="{{  request()->routeIs('admin.Categories.new') ? 'active' : '' }}"><a class="menu-item " href="{{route('admin.Categories.new')}}" data-i18n="nav.dash.crypto">أضافة قسم  </a>
                    </li>
                </ul>
            </li>

            <li class="nav-item {{  request()->routeIs('admin.Packages') ? 'active' : '' }}"><a href="{{route('admin.Packages')}}"><i class="la la-money"></i>
              <span class="menu-title" data-i18n="nav.changelog.main">الباقات </span>
              {{-- <span class="badge badge badge-pill badge-warning float-right" style=" left: 40px">{{App\Models\Package::count()}}</span> --}}
              </a>
            </li>
            ...
            <li class="nav-item  ">
              ...
              <ul class="menu-content">
                     <li class="{{  request()->routeIs('admin.Area') ? 'active' : '' }}"><a class="menu-item" href="{{route('admin.Area')}}" data-i18n="nav.dash.ecommerce"> عرض الكل </a></li>
                     <li class="{{  request()->routeIs('admin.Area.new') ? 'active' : '' }}"><a class="menu-item " href="{{route('admin.Area.new')}}" data-i18n="nav.dash.crypto">أضافة منطقة  </a></li>
              </ul>
            </li>
              ...
              <li class="nav-item  ">
                  ...
                  <ul class="menu-content">
                     <li class="{{  request()->routeIs('admin.places') ? 'active' : '' }}"><a class="menu-item" href="{{route('admin.places')}}" data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                     </li>
                     <li class="{{  request()->routeIs('admin.place.new') ? 'active' : '' }}"><a class="menu-item " href="{{route('admin.place.new')}}" data-i18n="nav.dash.crypto">أضافة محل  </a>
                     </li>
                  </ul>
              </li>
