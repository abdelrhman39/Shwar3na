...
<div class="card-body  ">
    @isset($gallary)
        @foreach ( $gallary as $img )
            ...
            <figure  style="margin: 10px; margin-bottom: 25px; float: right; ">
                <a href="{{route('admin.destroy.image' , $img->id)}}"><i class=" la la-trash-o" style=" font-size: xx-large;color: red; display: block; margin-right: 120px;" ></i></a>
                <a href="/uploads/places/{{$img->uploads}}" target="_blank">
                    <img class="img-thumbnail img-fluid" style="width: 250px;height:180px;" src="/uploads/places/{{$img->uploads}}"
