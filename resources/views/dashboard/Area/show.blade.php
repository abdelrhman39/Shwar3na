                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic example"> 
                                                                ...
                                                                <a href="{{route('admin.Area.edit',$each -> id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديل</a>
 
                                                                <a href="{{route('admin.location',$each -> id)}}"
                                                                    class="btn btn-outline-primary btn-min-width box-shadow-3  mr-1 mb-1">المواقع</a>
 
                                                                <a href="{{route('admin.Area.destroy', $each -> id)}}"
