                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title">جميع الباقات</h4>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group" role="group" aria-label="Basic example"> 
                                                                ...
                                                                <a href="{{route('admin.Packages.edit',$pack -> id)}}"
                                                                   class="btn btn-outline-primary btn-min-width box-shadow-3 mr-1 mb-1">تعديل</a>

                                                                <a href="{{route('admin.Packages.details',$pack -> id)}}"
                                                                    class="btn btn-outline-primary btn-min-width box-shadow-3  mr-1 mb-1">تفاصيل الباقة</a>
