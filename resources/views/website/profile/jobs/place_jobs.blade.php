                ...
                <div class="dashboard-message">
                    ...
                    <div class="dashboard-listing-table-image">
                        <a href="{{ url('jobs/'.$job->id) }}">
                            <img src="{{url('uploads/jobs/'.$job->main_image) }}"alt="{{$job->name}}"></a>
                    </div>
                    <div class="dashboard-listing-table-text">
                        <h4><a href="{{ url('jobs/'.$job->id) }}">{{$job->name}}</a></h4>
                        ...
                        <ul class="dashboard-listing-table-opt  fl-wrap">
                            ...
                            <li><a class="del-btn" href="{{ url('jobs/'.$job->id) }}"> عرض المنتج  <i class="far fa-eye"></i></a>
                            </li>
