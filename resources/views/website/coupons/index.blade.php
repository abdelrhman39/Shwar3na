...
@section('site_title', 'الكوبونات  \ التخفيضات')
@section('content')
                ...
                <section class="parallax-section" data-scrollax-parent="true">
                    ...
                    <div class="container">
                        <div class="section-title center-align">
                            <h2><span>كل الكوبونات</span></h2>
                            <div class="breadcrumbs fl-wrap" dir="rtl"><a href="{{ url('/index') }}">الرئيسية</a><a href="{{ url('/copouns') }}">الكوبونات</a><span></span></div>
